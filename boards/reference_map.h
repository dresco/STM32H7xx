...
/*
#define AUXINPUT0_ANALOG_PORT   GPIOA // ADC 1, channel 16
#define AUXINPUT0_ANALOG_PIN    0
#define AUXINPUT1_ANALOG_PORT   GPIOB // ADC 2, channel 5
#define AUXINPUT1_ANALOG_PIN    1
#define AUXINPUT2_ANALOG_PORT   GPIOF // ADC 3, channel 7
#define AUXINPUT2_ANALOG_PIN    8
*/
