...
#define AUXOUTPUT3_PORT             GPIOE   // ESP32 IO0
#define AUXOUTPUT3_PIN              9
#define AUXOUTPUT4_PORT             GPIOE   // ESP32 RST
#define AUXOUTPUT4_PIN              10

#if ESP_AT_ENABLE
#define COPROC_RESET_PORT           AUXOUTPUT4_PORT
#define COPROC_RESET_PIN            AUXOUTPUT4_PIN
#define COPROC_BOOT0_PORT           AUXOUTPUT3_PORT
#define COPROC_BOOT0_PIN            AUXOUTPUT3_PIN
#endif
